...
if git.modified_files.include?("Tuxedo.podspec") or git.modified_files.include?("Package.swift")
  warn "External contributor has edited the Tuxedo.podspec and/or Package.swift"
end
...
modified_carthage_xcode_project = !(git.modified_files.grep(/Tuxedo\.xcodeproj/).empty?)
